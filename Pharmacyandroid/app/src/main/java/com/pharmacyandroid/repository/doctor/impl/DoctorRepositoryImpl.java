package com.pharmacyandroid.repository.doctor.impl;
...
import com.pharmacyandroid.repository.doctor.DoctorRepository;
...
{
    private static final String TABLE_NAME = "Doctor.db";
    SQLiteDatabase db;
